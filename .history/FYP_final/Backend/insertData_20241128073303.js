...
const cities = [
  ...
  },
  {
    ...
    routes: [
      {
        id: "faisalabad-great-pakistan-mill",
        name: "Great Pakistan Mill",
        description:
          "One of the largest textile mills in Faisalabad, contributing to the city's industrial prominence.",
        screen: {
          id: "screen1",
          content: "Great Pakistan Mill content goes here.",
        },
      },
      {
        id: "faisalabad-punjab-banking-building",
        name: "Punjab Banking Building",
        description: "A historic building in the center of Faisalabad.",
        screen: {
          id: "screen1",
          content: "Punjab Banking Building content goes here.",
        },
      },
      {
        id: "faisalabad-jinnah-gardens",
        name: "Jinnah Gardens",
        description:
          "A central park, ideal for leisurely walks and community events.",
        screen: {
          id: "screen1",
          content: "Jinnah Gardens content goes here.",
        },
      },
      {
        id: "faisalabad-clock-tower",
        name: "Clock Tower",
        description:
          "A landmark clock tower surrounded by busy markets in Faisalabad.",
        screen: {
          id: "screen1",
          content: "Clock Tower content goes here.",
        },
      },
      {
        id: "faisalabad-baba-fareed-tomb",
        name: "Baba Fareed Tomb",
        description:
          "A historical tomb of the revered Sufi saint, Baba Fareed.",
        screen: {
          id: "screen1",
          content: "Baba Fareed Tomb content goes here.",
        },
      },
    ],
  },
